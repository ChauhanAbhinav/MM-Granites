...
##########Update Query################
	...
	if(isset($_POST['banner_update']))
	{
       		...
       		$query="UPDATE `$page` SET `id`='".$did."' ,`email`='".$email."',`phone`='".$phone."',`fax`='".$fax."'  WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			$empty="File Updated Successfully";
			echo'<script>
			alert("Updated Successfully");
			window.location.href="add-communication.php";
			</script>';
                  ...
                  <div class="x_content">
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                       <div class="form-group">
						...
						<div class="form-group"  >
							 <label for="discription">Edit Email</label> 
							 <input type="text" name="email" class="form-control" value="<?php echo $res3['email'];?>">
							  
						</div>
						<div class="form-group"  >
               <label for="discription">Edit Mobile/Phone No.</label> 
               <input type="text" name="phone" class="form-control" value="<?php echo $res3['phone'];?>">
                
            </div><div class="form-group"  >
               <label for="discription">Edit Fax No.</label> 
               <input type="text" name="fax" class="form-control" value="<?php echo $res3['fax'];?>">
