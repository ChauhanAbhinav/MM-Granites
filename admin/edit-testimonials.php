...
##########Update Query################
	...
	if ($_FILES['image']['tmp_name'] != '' ) {
       		$query="UPDATE `$page` SET `id`='".$did."', `image`='".$path."',`description`='".$description."' WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			echo'<script>
       alert("Updated Successfully");
       window.location.href="manage-testimonials.php";
      </script>';
			$empty="File Updated Successfully";
    }	
	if ($_FILES['image']['tmp_name'] == '' ) {
       		$query="UPDATE `$page` SET `id`='".$did."',`description`='".$description."' WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			echo'<script>
       alert("Updated Successfully");
       window.location.href="manage-testimonials.php";
    ...
    <div class="container body">
      ...
      <?php include 'slider-bar.php';?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="form-group"  >
               <label for="discription">Edit Feedbacks</label> 
