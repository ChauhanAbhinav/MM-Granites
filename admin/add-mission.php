                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      <div class="form-group">
						...
						<div class="form-group"  >
							 <label for="discription">Enter Heading</label> 
					 ...
					 <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success" name="add_mission">Upload</button>
                  ...
                  <div class="x_content">
                   <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
						 <?php
                                    $q1="SELECT * FROM `mission` ORDER BY `id` desc";
                            ...
                            <tr class="even pointer">
								...
								<td class=" "><?php echo $res3['content'];?></td>
				                
								<td class=" "><a class="btn btn-primary" href="edit-mission.php?did=<?php echo $res3['id'];?>&action=edit&page=mission"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=mission">Delete</td>
						    </tr>
