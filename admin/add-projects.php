...
{	
	...
	{
		$path = "project_images/" . $_FILES['image']['name'];
    	move_uploaded_file($_FILES['image']['tmp_name'], $path);
	if ($_FILES['image']['tmp_name'] != '' ) {
       		$query="INSERT INTO `projects` (`id`,`image`,`name`,`description`) VALUES ('','".$path."','".addslashes($name)."','".$description."')";
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Project Image</th>
						 ...
						 <?php
                            ...
                            <tr class="even pointer">
							  ...
							  <td class=" "><?php echo $res3['description'];?></td>
								...
								<td class=" "><a class="btn btn-primary" href="edit-projects.php?did= <?php echo $res3['id'];?>&action=edit&page=projects"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=projects">Delete</td>
						    </tr>
						         <?php
									}
									?>
