                  ...
                  <div class="x_content">
                   <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
						 <?php
                                    $q1="SELECT * FROM `why_us_contents` ORDER BY `id` desc";
                            ...
                            <tr class="even pointer">
								...
								<td class=" "><a class="btn btn-primary" href="edit-whyus.php?did=<?php echo $res3['id'];?>&action=edit&page=why_us_contents"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=why_us_contents">Delete</td>
						    </tr>
