              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<div class="form-group"  >
							 <label for="discription">Enter Feedback/Testimonials</label> 
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Feedbacks</th>
						 ...
						 <?php
                            ...
                            <tr class="even pointer">
							  ...
							  <td class=" "><?php echo $res3['description'];?></td>
								...
								<td class=" "><a class="btn btn-primary" href="edit-testimonials.php?did= <?php echo $res3['id'];?>&action=edit&page=testimonials"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=testimonials">Delete</td>
						    </tr>
						         <?php
									}
									?>
