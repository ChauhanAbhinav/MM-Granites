                        ...
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Brief Description</th>
							              <th class="column-title">Detail Description</th>
                        ...
                        <tbody>
						 <?php
                            ...
                            <tr class="even pointer">
								...
								<td class=" "><?php echo $res3['brief'];?></td>
							  <td class=" "><?php echo $res3['description'];?></td>
								
								<td class=" "><a class="btn btn-primary" href="edit-products.php?did= <?php echo $res3['id'];?>&action=edit&page=products"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=products">Delete</td>
						    </tr>
						         <?php
									}
									?>
