          ...
          <div class="">
            ...
            <div class="row" style="margin:auto 0px">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3><b>Add Company Contacts Details</b></h3>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      <div class="form-group">
						...
						<div class="form-group"  >
							 <label for="discription">Enter Email</label> 
							 <input type="text" name="email" class="form-control"  >
							 
						</div>
						<div class="form-group"  >
               <label for="discription">Enter Mobile/Phone No.</label> 
               <input type="text" name="phone" class="form-control"  >
               
            </div>
            <div class="form-group"  >
               <label for="discription">Enter Fax No.</label> 
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Phone/Mobile</th>
                        ...
                        <tbody>
						 <?php
                                    $q1="SELECT * FROM `company_contacts` ORDER BY `id` desc";
                ...
                <td class=" "><?php echo $res3['fax'];?></td>
                
				                
								<td class=" "><a class="btn btn-primary" href="edit-communication.php?did=<?php echo $res3['id'];?>&action=edit&page=company_contacts"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=company_contacts">Delete</td>
						    </tr>
