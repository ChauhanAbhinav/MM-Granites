                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <input class="file" id="fileInput" type="file" name="image" class="form-control">
                        ...
                        <tbody>
						 <?php
                            ...
                            <tr class="even pointer">
								...
								<td class=" "><img src="<?php echo $res3['profile_photo'];?>" width="140px" height="80px"></td>
                <td class=" "><?php echo $res3['designation'];?></td>
							  <td class=" "><?php echo $res3['qualification'];?></td>
								
								<td class=" "><a class="btn btn-primary" href="edit-team-member.php?did= <?php echo $res3['id'];?>&action=edit&page=team"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=team">Delete</td>
						    </tr>
						         <?php
									}
									?>
