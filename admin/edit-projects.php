...
##########Update Query################
	...
	if ($_FILES['image']['tmp_name'] != '' ) {
       		$query="UPDATE `$page` SET `id`='".$did."', `image`='".$path."',`name`='".$name."',`description`='".$description."' WHERE `id`='".$did."'";
	...
	if ($_FILES['image']['tmp_name'] == '' ) {
       		$query="UPDATE `$page` SET `id`='".$did."',`name`='".$name."',`description`='".$description."' WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			echo'<script>
       alert("Updated Successfully");
       window.location.href="add-projects.php";
      ...
      <?php include 'slider-bar.php';?>
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="form-group"  >
               <label for="discription">Edit Product Name</label> 
